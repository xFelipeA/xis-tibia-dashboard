// Dados completos dos Imbuements (convertido do Python)
...
function populateImbuementsTable(data) {
    ...
    data.forEach(imb => {
        ...
        row.innerHTML = `
            ...
            <td style="text-align: center; font-weight: bold;">${imb.categoria}</td>
...
// Adiciona suporte para ordenação
function sortImbuements(columnIndex) {
    const tbody = document.getElementById('imbuements-table-body');
...
document.addEventListener('DOMContentLoaded', function() {
    // Verifica se estamos na página de imbuements
    if (document.getElementById('imbuement-search')) {
